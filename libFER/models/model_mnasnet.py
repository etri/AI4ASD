""" 
   * Source: libFER.models.model_mnasnet.py
...
class _InvertedResidual(nn.Module):
    ...
    """_InvertedResidual class

    Note: class for _InvertedResidual
...
def _round_to_multiple_of(val, divisor, round_up_bias=0.9):
    ...
    """_round_to_multiple_of function

    Note: function for _round_to_multiple_of
...
def _get_depths(alpha):
    ...
    """_get_depths function

    Note: function for _get_depths
...
class MNASNet(torch.nn.Module):
    ...
    def _initialize_weights(self):
        ...
        """_initialize_weights function

        Note: function for _initialize_weights
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        """_load_from_state_dict function

        Note: function for _load_from_state_dict
...
def _load_pretrained(model_name, model, progress):
    ...
    """_load_pretrained function

    Note: function for _load_pretrained

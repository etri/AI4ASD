""" 
   * Source: libFER.models.model_shufflenetv2.py
...
def channel_shuffle(x, groups):
    ...
    Note: function for channel_shuffle
...
class InvertedResidual(nn.Module):
    ...
    Note: class for InvertedResidual
    ...
    def depthwise_conv(i, o, kernel_size, stride=1, padding=0, bias=False):
        ...
        Note: function for depthwise_conv

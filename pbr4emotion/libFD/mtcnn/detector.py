""" 
   * Source: libFD.mtcnn.detector.py
...
from libFD.mtcnn.box_utils import nms, calibrate_box, get_image_boxes, convert_to_square
from libFD.mtcnn.first_stage import run_first_stage
from libFD.mtcnn.models import PNet, RNet, ONet
...
class MtcnnDetector:
    ...
    def detect_faces(self, image, min_face_size=20.0,
        ...
        with torch.no_grad():
            ...
            if all(v is None for v in bounding_boxes):
                return [], []

...
from libFD.retinaface.data import cfg_mnet, cfg_re50
from libFD.retinaface.models.retinaface import RetinaFace
...
def load_model(net='mnet'):
    ...
    if net == 'mnet':
        pretrained_path = 'libFD/retinaface/weights/mobilenet0.25_Final.pth'
        # print('Loading pretrained model from {}'.format(pretrained_path))
        model = RetinaFace(cfg=cfg_mnet, phase='test')
    else:
        pretrained_path = 'libFD/retinaface/weights/Resnet50_Final.pth'
        # print('Loading pretrained model from {}'.format(pretrained_path))
